...
What this package can run on, what sets each limit, and what is still unverified. Status is tracked as batch `B4` in the [development tracker](development.md).
